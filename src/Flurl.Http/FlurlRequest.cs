...
namespace Flurl.Http
{
    ...
    public interface IFlurlRequest : IHttpSettingsContainer
    {
        ...
        /// <summary>
        /// Gets or sets custom IHttpClientFactory, null as default
        /// </summary>
        IHttpClientFactory CustomHttpClientFactory { get; set; }
    ...
    /// <summary>
    /// Fluent API provider for IFlurlRequest
    /// </summary>
    public static class IFlurlRequestExtensions
    {
        ...
        public static IFlurlRequest WithCustomHttpClientFactory(
            ...
            IHttpClientFactory httpClientFactory)
        {
            request.CustomHttpClientFactory = httpClientFactory;
            return request;
        }
    }
}
